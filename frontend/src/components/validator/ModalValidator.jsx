      ...
      <div className="flex items-end justify-center min-h-screen pt-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                  ...
                  <form>
                    ...
                    <div className="flex flex-wrap w-full sm:items-center p-6">
                      ...
                      <div className="mt-1 relative w-full">
                        ...
                        >
                          {showPassword ? (
                            <BsFillEyeSlashFill className="h-5 w-5 text-gray-500" aria-hidden="true" />
                          ) : (
                            <BsFillEyeFill className="h-5 w-5 text-gray-500" aria-hidden="true" />
                          )}
                        </button>
                      </div>
                    </div>
          ...
          <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
            <button onClick={onCreateAccount} type="button" className="py-3 w-full mb-3 text-center text-white bg-black dark:bg-gray-300 dark:text-black flex justify-center items-center">
              CREATE ACCOUNT
            </button>
          </div>
        </div>
